...
import com.jpmorgan.stocks.simple.persistence.StocksEntityManager;


import com.jpmorgan.stocks.simple.beanconfig.SpringService;
...
public class SimpleStockServicesFactoryTest {
	...
	public void recordATradeTest(){
		...
		SimpleStockService simpleStockService = SpringService.INSTANCE.getBean("simpleStocksService", SimpleStockService.class);
		...
		try{
			// Initial trades are empty, means, trades number equls to 0
